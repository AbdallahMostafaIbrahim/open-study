...
export default function CreateCourseMaterial() {
  ...
  const createMaterial = api.professor.courses.material.create.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="container max-w-5xl">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold">Add New Course Material</h1>
        <p className="text-muted-foreground mt-2">
          Create new content for your students to access.
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Basic information about this course material.
              </CardDescription>
            </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    ...
                    <GroupSelector field={field} sectionId={sectionId} />
                    <FormDescription>
