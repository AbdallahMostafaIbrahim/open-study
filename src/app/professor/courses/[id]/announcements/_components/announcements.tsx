...
export const Announcements = ({ sectionId }: { sectionId: number }) => {
  ...
  const [announcements, { isLoading, error }] =
    api.professor.courses.announcements.get.useSuspenseQuery({
      sectionId,
    });
  ...
  // Render the add announcement button
  const renderAddButton = () => (
    <Link href={`/professor/courses/${sectionId}/announcements/new`}>
      <Button>
  ...
  const EmptyState = () => (
    <div className="flex flex-col items-center justify-center space-y-4 py-16 text-center">
      ...
      <p className="text-muted-foreground max-w-md">
        Add your first announcement to help your students access important
        resources.
      </p>
